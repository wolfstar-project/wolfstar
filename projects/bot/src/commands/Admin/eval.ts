...
export class UserCommand extends WolfCommand {
	...
	private async timedEval(message: Message, args: WolfCommand.Args, code: string, flagTime: number) {
	...
	// Eval the input
	private async eval(message: Message, args: WolfCommand.Args, code: string) {
