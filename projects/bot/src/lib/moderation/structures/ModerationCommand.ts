...
import { floatPromise, seconds, years } from '#common';
...
export abstract class ModerationCommand<T = unknown> extends WolfCommand {
	/**
...
export namespace ModerationCommand {
	 ...
	 */
	export interface Options extends WolfCommand.Options {
		requiredMember?: boolean;
		optionalDuration?: boolean;
	}

	export type Args = WolfCommand.Args;
	export type Context = WolfCommand.Context;
}
