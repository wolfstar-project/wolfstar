...
export type { FetchOptions, ICache } from './lib/cache/interfaces/ICache.js';
...
export type { IStructureCreator } from './lib/cache/structures/interfaces/IStructureCreator.js';
