...
-- Drop existing migrations table and recreate in system schema
DROP TABLE IF EXISTS public.migrations CASCADE;
DROP TABLE IF EXISTS system.migrations CASCADE;
...
INSERT INTO system.migrations ("timestamp", name)
VALUES
	...
	(1720000000000, 'V81RemoveTwitchSubscriptions1720000000000'),
	(1726000000000, 'V82EnableMultiSchema1726000000000');
