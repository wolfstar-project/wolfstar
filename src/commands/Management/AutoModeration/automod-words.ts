import { readSettings, writeSettings, type GuildEntity } from '#lib/database';
...
import type { WolfSubcommand } from '#lib/structures';
...
export class UserAutoModerationCommand extends AutoModerationCommand {
	/** @deprecated */
	public messageRunAdd(message: GuildMessage, args: WolfSubcommand.Args) {
	...
	/** @deprecated */
	public messageRunRemove(message: GuildMessage, args: WolfSubcommand.Args) {
