...
export class UserCommand extends WolfSubcommand {
	public override registerApplicationCommands(registry: ApplicationCommandRegistry) {
		registry.registerChatInputCommand(
			...
			{
				idHints: [
					'1239990630537629716' // wolfstar-prod production
	...
	public async chatInputRunView(interaction: WolfSubcommand.Interaction) {
	...
	public async chatInputRunList(interaction: WolfSubcommand.Interaction) {
	...
	public async chatInputRunEdit(interaction: WolfSubcommand.Interaction) {
		const entry = await this.#getCase(interaction, true);
	...
	public async chatInputRunArchive(interaction: WolfSubcommand.Interaction) {
		const entry = await this.#getCase(interaction, true);
	...
	public async chatInputRunDelete(interaction: WolfSubcommand.Interaction) {
		const entry = await this.#getCase(interaction, true);
	...
	public async viewMessageRun(message: GuildMessage, args: WolfSubcommand.Args) {
		return send(message, {
	...
	public async deleteMessageRun(message: GuildMessage, args: WolfCommand.Args) {
		return send(message, {
			content: args.t(LanguageKeys.Commands.Shared.DeprecatedMessage, {
	...
	async #listDetails(
		interaction: WolfSubcommand.Interaction,
		t: TFunction,
	...
	async #listOverview(interaction: WolfSubcommand.Interaction, t: TFunction, entries: ModerationManager.Entry[], user: User | null, show: boolean) {
	...
	#getDuration(interaction: WolfSubcommand.Interaction, entry: ModerationManager.Entry) {
	...
	async #getCase(interaction: WolfSubcommand.Interaction, required: true): Promise<ModerationManager.Entry>;
	async #getCase(interaction: WolfSubcommand.Interaction, required?: false): Promise<ModerationManager.Entry | null>;
	async #getCase(interaction: WolfSubcommand.Interaction, required?: boolean) {
