...
export class UserCommand extends WolfCommand {
	...
	public override contextMenuRun(interaction: WolfCommand.UserContextMenuInteraction) {
		return this.#sharedRun(interaction, interaction.targetMember!, false, false, false);
	}

	#sharedRun(
		interaction: WolfCommand.ChatInputInteraction | WolfCommand.UserContextMenuInteraction,
		target: GuildMember,
		listAll: boolean,
		listMissing: boolean,
		show: boolean
