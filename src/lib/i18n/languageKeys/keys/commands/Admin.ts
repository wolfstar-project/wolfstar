...
export const ConfMenuDescription = T<string>('commands/admin:confMenuDescription');
export const ConfShowDescription = T<string>('commands/admin:confShowDescription');
export const ConfSetDescription = T<string>('commands/admin:confSetDescription');
export const ConfRemoveDescription = T<string>('commands/admin:confRemoveDescription');
export const ConfResetDescription = T<string>('commands/admin:confResetDescription');
export const ConfOptionKey = T<string>('commands/admin:confOptionKey');
export const ConfOptionValue = T<string>('commands/admin:confOptionValue');
