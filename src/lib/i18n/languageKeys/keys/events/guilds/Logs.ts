...
export const CommandExecuteTitle = T('events/guilds-logs:commandExecuteTitle');
export const SettingsUpdateTitle = T('events/guilds-logs:settingsUpdateTitle');
export const SettingsAccessDeniedTitle = T('events/guilds-logs:settingsAccessDeniedTitle');
export const LogFieldUser = T('events/guilds-logs:logFieldUser');
export const LogFieldCommand = T('events/guilds-logs:logFieldCommand');
export const LogFieldType = T('events/guilds-logs:logFieldType');
export const LogFieldChannel = T('events/guilds-logs:logFieldChannel');
export const LogFieldAction = T('events/guilds-logs:logFieldAction');
